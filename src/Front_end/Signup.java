...
public void addPlaceholderStyle(JTextField textfield) {
    ...
    private void initComponents() {
        ...
        usernametext = new Back_end.MyTextField();
        emailtext = new Back_end.MyTextField();
        password = new Back_end.MyPasswordField();
        password2 = new Back_end.MyPasswordField();
        signup = new Back_end.MyButton();
...
String username = usernametext.getText();
    ...
    private Back_end.MyTextField emailtext;
    ...
    private Back_end.MyPasswordField password;
    private Back_end.MyPasswordField password2;
    private Back_end.MyButton signup;
    private Back_end.MyTextField usernametext;
