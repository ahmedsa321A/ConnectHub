...
import Back_end.Content;
import Back_end.ContentDatabase;
...
public class PostGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        myTextArea1 = new Back_end.MyTextArea();
        myTextArea2 = new Back_end.MyTextArea();
        myTextArea3 = new Back_end.MyTextArea();
        publish = new javax.swing.JButton();
        cancel = new javax.swing.JButton();
        pic = new javax.swing.JLabel();
        removeButton1 = new javax.swing.JButton();
        jScrollPane1 = new javax.swing.JScrollPane();
        posttext = new Back_end.MyTextArea();
        addphoto = new Back_end.MyButton();
        back = new Back_end.MyButton();
    ...
    private void publishActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_publishActionPerformed
        ...
        if (text.equals("Write Here.....")) {
            ...
            Content post = new Content(UUID.randomUUID().toString(), user.getUserId(), text, photopath, false);
            db.addContent(post);
            db.saveContent();
    ...
    private Back_end.MyButton addphoto;
    private Back_end.MyButton back;
    private javax.swing.JButton cancel;
    private javax.swing.JButton jButton3;
    private javax.swing.JScrollPane jScrollPane1;
    private Back_end.MyTextArea myTextArea1;
    private Back_end.MyTextArea myTextArea2;
    private Back_end.MyTextArea myTextArea3;
    private javax.swing.JLabel pic;
    private Back_end.MyTextArea posttext;
