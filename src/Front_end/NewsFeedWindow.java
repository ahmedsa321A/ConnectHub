...
public class NewsFeedWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        home = new Back_end.MyButton();
        story = new Back_end.MyButton();
        post = new Back_end.MyButton();
        friends = new Back_end.MyButton();
        refresh = new Back_end.MyButton();
        profile = new Back_end.MyButton();
        stories = new Back_end.MyButton();
        logout = new Back_end.MyButton();
...
StoryGui story = new StoryGui(user);      
    ...
    private Back_end.MyButton friends;
    private Back_end.MyButton home;
    private javax.swing.JPanel jPanel1;
    private javax.swing.JScrollPane jScrollPane1;
    private Back_end.MyButton logout;
    private javax.swing.JPanel newsFeedPanel;
    private Back_end.MyButton post;
    private Back_end.MyButton profile;
    private Back_end.MyButton refresh;
    private Back_end.MyButton stories;
    private Back_end.MyButton story;
